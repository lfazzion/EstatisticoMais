...
export default function ReadingMaterialsScreen() {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Header title="Leitura" showBackButton />
      <View style={styles.content}>
        <Text style={styles.text}>Aqui você pode adicionar materiais de leitura.</Text>
        {/* Implemente os materiais ou links para materiais aqui */}
      </View>
    </SafeAreaView>
  );
}
